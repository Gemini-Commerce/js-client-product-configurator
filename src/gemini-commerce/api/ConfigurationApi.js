...
* @module gemini-commerce/api/ConfigurationApi
* @version v1
*/
export default class ConfigurationApi {
    ...
    * @alias module:gemini-commerce/api/ConfigurationApi
    * @class
    ...
    */
     ...
     * @callback module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetAvailableConfigurationCallback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse} data The data returned by the service call.
     ...
     * @param {module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetAvailableConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse}
     */
     ...
     * @callback module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetAvailableConfiguration2Callback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} productId 
     * @param {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationRequest} body 
     * @param {module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetAvailableConfiguration2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse}
     */
     ...
     * @callback module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetConfigurationFromSelectionsCallback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/ConfigurationGetConfigurationFromSelectionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} productId 
     * @param {module:gemini-commerce/model/ConfigurationGetConfigurationFromSelectionsRequest} body 
     * @param {module:gemini-commerce/api/ConfigurationApi~productConfiguratorGetConfigurationFromSelectionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/ConfigurationGetConfigurationFromSelectionsResponse}
     */
