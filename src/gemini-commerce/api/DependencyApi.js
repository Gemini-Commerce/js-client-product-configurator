...
/**
* Dependency service.
* @module gemini-commerce/api/DependencyApi
* @version v1
*/
export default class DependencyApi {
    ...
    * @alias module:gemini-commerce/api/DependencyApi
    * @class
    ...
    */
     ...
     * @callback module:gemini-commerce/api/DependencyApi~productConfiguratorCreateDependencyCallback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/ProductconfiguratordependencyEntity} data The data returned by the service call.
     ...
     * @param {String} stepId 
     * @param {module:gemini-commerce/model/ProductconfiguratordependencyCreateRequest} body 
     * @param {module:gemini-commerce/api/DependencyApi~productConfiguratorCreateDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/ProductconfiguratordependencyEntity}
     */
     ...
     * @callback module:gemini-commerce/api/DependencyApi~productConfiguratorDeleteDependencyCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:gemini-commerce/api/DependencyApi~productConfiguratorDeleteDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:gemini-commerce/api/DependencyApi~productConfiguratorListDependenciesCallback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/DependencyListDependenciesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:gemini-commerce/model/DependencyListDependenciesRequest} body 
     * @param {module:gemini-commerce/api/DependencyApi~productConfiguratorListDependenciesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/DependencyListDependenciesResponse}
     */
     ...
     * @callback module:gemini-commerce/api/DependencyApi~productConfiguratorUpdateDependencyCallback
     * @param {String} error Error message, if any.
     * @param {module:gemini-commerce/model/ProductconfiguratordependencyEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} dependencyId 
     * @param {module:gemini-commerce/model/ProductconfiguratordependencyUpdateRequest} body 
     * @param {module:gemini-commerce/api/DependencyApi~productConfiguratorUpdateDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:gemini-commerce/model/ProductconfiguratordependencyEntity}
     */
