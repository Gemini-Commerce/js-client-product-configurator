 ...
 * @module gemini-commerce/model/ProductconfiguratorstepUpdateRequest
 * @version v1
 */
class ProductconfiguratorstepUpdateRequest {
    /**
     * Constructs a new <code>ProductconfiguratorstepUpdateRequest</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorstepUpdateRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorstepUpdateRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorstepUpdateRequest} The populated <code>ProductconfiguratorstepUpdateRequest</code> instance.
     */
...
/**
 * @member {module:gemini-commerce/model/ProductconfiguratorstepUpdatePayload} payload
 */
