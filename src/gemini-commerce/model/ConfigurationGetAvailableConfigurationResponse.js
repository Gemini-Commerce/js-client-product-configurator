 ...
 * @module gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse
 * @version v1
 */
class ConfigurationGetAvailableConfigurationResponse {
     ...
     * @alias module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationResponse} The populated <code>ConfigurationGetAvailableConfigurationResponse</code> instance.
     */
...
/**
 * @member {module:gemini-commerce/model/ConfigurationConfigurator} configurator
 */
