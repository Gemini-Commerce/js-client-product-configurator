 ...
 * @module gemini-commerce/model/ProductconfiguratordependencyUpdatePayload
 * @version v1
 */
class ProductconfiguratordependencyUpdatePayload {
    /**
     * Constructs a new <code>ProductconfiguratordependencyUpdatePayload</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratordependencyUpdatePayload
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratordependencyUpdatePayload} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratordependencyUpdatePayload} The populated <code>ProductconfiguratordependencyUpdatePayload</code> instance.
     */
