 ...
 * @module gemini-commerce/model/ProductconfiguratoroptionUpdatePayload
 * @version v1
 */
class ProductconfiguratoroptionUpdatePayload {
    /**
     * Constructs a new <code>ProductconfiguratoroptionUpdatePayload</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratoroptionUpdatePayload
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratoroptionUpdatePayload} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratoroptionUpdatePayload} The populated <code>ProductconfiguratoroptionUpdatePayload</code> instance.
     */
