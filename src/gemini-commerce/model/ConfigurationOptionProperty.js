 ...
 * @module gemini-commerce/model/ConfigurationOptionProperty
 * @version v1
 */
class ConfigurationOptionProperty {
    /**
     * Constructs a new <code>ConfigurationOptionProperty</code>.
     * @alias module:gemini-commerce/model/ConfigurationOptionProperty
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ConfigurationOptionProperty} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ConfigurationOptionProperty} The populated <code>ConfigurationOptionProperty</code> instance.
     */
