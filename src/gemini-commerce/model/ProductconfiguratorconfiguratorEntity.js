 ...
 * @module gemini-commerce/model/ProductconfiguratorconfiguratorEntity
 * @version v1
 */
class ProductconfiguratorconfiguratorEntity {
    /**
     * Constructs a new <code>ProductconfiguratorconfiguratorEntity</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorconfiguratorEntity
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorconfiguratorEntity} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorconfiguratorEntity} The populated <code>ProductconfiguratorconfiguratorEntity</code> instance.
     */
