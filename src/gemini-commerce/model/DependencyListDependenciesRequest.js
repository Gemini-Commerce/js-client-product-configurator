 ...
 * @module gemini-commerce/model/DependencyListDependenciesRequest
 * @version v1
 */
class DependencyListDependenciesRequest {
    /**
     * Constructs a new <code>DependencyListDependenciesRequest</code>.
     * @alias module:gemini-commerce/model/DependencyListDependenciesRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/DependencyListDependenciesRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/DependencyListDependenciesRequest} The populated <code>DependencyListDependenciesRequest</code> instance.
     */
