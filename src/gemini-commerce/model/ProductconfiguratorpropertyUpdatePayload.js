 ...
 * @module gemini-commerce/model/ProductconfiguratorpropertyUpdatePayload
 * @version v1
 */
class ProductconfiguratorpropertyUpdatePayload {
    /**
     * Constructs a new <code>ProductconfiguratorpropertyUpdatePayload</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorpropertyUpdatePayload
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorpropertyUpdatePayload} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorpropertyUpdatePayload} The populated <code>ProductconfiguratorpropertyUpdatePayload</code> instance.
     */
...
/**
 * @member {module:gemini-commerce/model/PropertyUpdatePayloadGenericProperty} genericProperty
 */
ProductconfiguratorpropertyUpdatePayload.prototype['genericProperty'] = undefined;

/**
 * @member {module:gemini-commerce/model/PropertyUpdatePayloadWeightProperty} weightProperty
 */
ProductconfiguratorpropertyUpdatePayload.prototype['weightProperty'] = undefined;

/**
 * @member {module:gemini-commerce/model/PropertyUpdatePayloadPriceProperty} priceProperty
 */
