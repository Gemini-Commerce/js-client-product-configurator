 ...
 * @module gemini-commerce/model/ProductconfiguratoroptionBulkCreateResponse
 * @version v1
 */
class ProductconfiguratoroptionBulkCreateResponse {
    /**
     * Constructs a new <code>ProductconfiguratoroptionBulkCreateResponse</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratoroptionBulkCreateResponse
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratoroptionBulkCreateResponse} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratoroptionBulkCreateResponse} The populated <code>ProductconfiguratoroptionBulkCreateResponse</code> instance.
     */
