 ...
 * @module gemini-commerce/model/ProductconfiguratorconfiguratorUpdateRequest
 * @version v1
 */
class ProductconfiguratorconfiguratorUpdateRequest {
     ...
     * @alias module:gemini-commerce/model/ProductconfiguratorconfiguratorUpdateRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorconfiguratorUpdateRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorconfiguratorUpdateRequest} The populated <code>ProductconfiguratorconfiguratorUpdateRequest</code> instance.
     */
...
/**
 * @member {module:gemini-commerce/model/ProductconfiguratorconfiguratorUpdatePayload} payload
 */
