 ...
 * @module gemini-commerce/model/ProtobufAny
 * @version v1
 */
class ProtobufAny {
    /**
     * Constructs a new <code>ProtobufAny</code>.
     * @alias module:gemini-commerce/model/ProtobufAny
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProtobufAny} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProtobufAny} The populated <code>ProtobufAny</code> instance.
     */
