 ...
 * @module gemini-commerce/model/ProductconfiguratorstepEntity
 * @version v1
 */
class ProductconfiguratorstepEntity {
    /**
     * Constructs a new <code>ProductconfiguratorstepEntity</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorstepEntity
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorstepEntity} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorstepEntity} The populated <code>ProductconfiguratorstepEntity</code> instance.
     */
