 ...
 * @module gemini-commerce/model/DependencyListDependenciesResponse
 * @version v1
 */
class DependencyListDependenciesResponse {
    /**
     * Constructs a new <code>DependencyListDependenciesResponse</code>.
     * @alias module:gemini-commerce/model/DependencyListDependenciesResponse
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/DependencyListDependenciesResponse} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/DependencyListDependenciesResponse} The populated <code>DependencyListDependenciesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:gemini-commerce/model/ProductconfiguratordependencyEntity>} dependencies
 */
