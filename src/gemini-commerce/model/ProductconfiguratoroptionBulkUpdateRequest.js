 ...
 * @module gemini-commerce/model/ProductconfiguratoroptionBulkUpdateRequest
 * @version v1
 */
class ProductconfiguratoroptionBulkUpdateRequest {
    /**
     * Constructs a new <code>ProductconfiguratoroptionBulkUpdateRequest</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratoroptionBulkUpdateRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratoroptionBulkUpdateRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratoroptionBulkUpdateRequest} The populated <code>ProductconfiguratoroptionBulkUpdateRequest</code> instance.
     */
...
/**
 * @member {Array.<module:gemini-commerce/model/ProductconfiguratoroptionBulkUpdateRequestUpdateEntity>} options
 */
