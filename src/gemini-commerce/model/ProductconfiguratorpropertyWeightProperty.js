 ...
 * @module gemini-commerce/model/ProductconfiguratorpropertyWeightProperty
 * @version v1
 */
class ProductconfiguratorpropertyWeightProperty {
    /**
     * Constructs a new <code>ProductconfiguratorpropertyWeightProperty</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorpropertyWeightProperty
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorpropertyWeightProperty} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorpropertyWeightProperty} The populated <code>ProductconfiguratorpropertyWeightProperty</code> instance.
     */
