 ...
 * @module gemini-commerce/model/ConfigurationProperty
 * @version v1
 */
class ConfigurationProperty {
    /**
     * Constructs a new <code>ConfigurationProperty</code>.
     * @alias module:gemini-commerce/model/ConfigurationProperty
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ConfigurationProperty} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ConfigurationProperty} The populated <code>ConfigurationProperty</code> instance.
     */
...
/**
 * @member {module:gemini-commerce/model/ProductconfiguratorPropertyMode} propertyMode
 */
