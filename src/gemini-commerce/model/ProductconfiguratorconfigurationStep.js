 ...
 * @module gemini-commerce/model/ProductconfiguratorconfigurationStep
 * @version v1
 */
class ProductconfiguratorconfigurationStep {
    /**
     * Constructs a new <code>ProductconfiguratorconfigurationStep</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorconfigurationStep
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorconfigurationStep} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorconfigurationStep} The populated <code>ProductconfiguratorconfigurationStep</code> instance.
     */
...
/**
 * @member {Array.<module:gemini-commerce/model/ProductconfiguratorconfigurationOption>} options
 */
