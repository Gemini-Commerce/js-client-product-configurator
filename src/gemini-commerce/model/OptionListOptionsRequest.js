 ...
 * @module gemini-commerce/model/OptionListOptionsRequest
 * @version v1
 */
class OptionListOptionsRequest {
    /**
     * Constructs a new <code>OptionListOptionsRequest</code>.
     * @alias module:gemini-commerce/model/OptionListOptionsRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/OptionListOptionsRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/OptionListOptionsRequest} The populated <code>OptionListOptionsRequest</code> instance.
     */
