 ...
 * @module gemini-commerce/model/ProductconfiguratorpropertyPriceProperty
 * @version v1
 */
class ProductconfiguratorpropertyPriceProperty {
    /**
     * Constructs a new <code>ProductconfiguratorpropertyPriceProperty</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratorpropertyPriceProperty
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratorpropertyPriceProperty} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratorpropertyPriceProperty} The populated <code>ProductconfiguratorpropertyPriceProperty</code> instance.
     */
