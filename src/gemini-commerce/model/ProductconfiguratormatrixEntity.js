 ...
 * @module gemini-commerce/model/ProductconfiguratormatrixEntity
 * @version v1
 */
class ProductconfiguratormatrixEntity {
    /**
     * Constructs a new <code>ProductconfiguratormatrixEntity</code>.
     * @alias module:gemini-commerce/model/ProductconfiguratormatrixEntity
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ProductconfiguratormatrixEntity} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ProductconfiguratormatrixEntity} The populated <code>ProductconfiguratormatrixEntity</code> instance.
     */
