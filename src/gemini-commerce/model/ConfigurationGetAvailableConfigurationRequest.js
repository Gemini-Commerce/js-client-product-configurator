 ...
 * @module gemini-commerce/model/ConfigurationGetAvailableConfigurationRequest
 * @version v1
 */
class ConfigurationGetAvailableConfigurationRequest {
     ...
     * @alias module:gemini-commerce/model/ConfigurationGetAvailableConfigurationRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/ConfigurationGetAvailableConfigurationRequest} The populated <code>ConfigurationGetAvailableConfigurationRequest</code> instance.
     */
...
/**
 * @member {Array.<module:gemini-commerce/model/ConfigurationPropertyFilter>} propertyFilters
 */
