 ...
 * @module gemini-commerce/model/PropertyListPropertiesRequest
 * @version v1
 */
class PropertyListPropertiesRequest {
    /**
     * Constructs a new <code>PropertyListPropertiesRequest</code>.
     * @alias module:gemini-commerce/model/PropertyListPropertiesRequest
     */
    constructor() { 
     ...
     * @param {module:gemini-commerce/model/PropertyListPropertiesRequest} obj Optional instance to populate.
     * @return {module:gemini-commerce/model/PropertyListPropertiesRequest} The populated <code>PropertyListPropertiesRequest</code> instance.
     */
