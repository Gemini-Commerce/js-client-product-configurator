...
export default class StepApi {
    ...
    */
     ...
     * @callback module:api/StepApi~productConfiguratorBulkCreateStepsCallback
     ...
     * @param {module:api/StepApi~productConfiguratorBulkCreateStepsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/StepApi~productConfiguratorBulkDeleteStepsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StepApi~productConfiguratorBulkDeleteStepsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/StepApi~productConfiguratorCopyStepCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StepApi~productConfiguratorCopyStepCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/StepApi~productConfiguratorCreateStepCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProductconfiguratorstepEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/StepApi~productConfiguratorCreateStepCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProductconfiguratorstepEntity}
     */
     ...
     * @callback module:api/StepApi~productConfiguratorDeleteStepCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GooglerpcStatus} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} stepId 
     * @param {module:api/StepApi~productConfiguratorDeleteStepCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GooglerpcStatus}
     */
     ...
     * @callback module:api/StepApi~productConfiguratorUpdateStepCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProductconfiguratorstepEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/StepApi~productConfiguratorUpdateStepCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProductconfiguratorstepEntity}
     */
