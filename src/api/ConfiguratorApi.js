...
export default class ConfiguratorApi {
    ...
    */
     ...
     * @callback module:api/ConfiguratorApi~productConfiguratorCopyConfiguratorCallback
     ...
     * @param {module:api/ConfiguratorApi~productConfiguratorCopyConfiguratorCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ConfiguratorApi~productConfiguratorDeleteConfiguratorCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ConfiguratorApi~productConfiguratorDeleteConfiguratorCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ConfiguratorApi~productConfiguratorUpdateConfiguratorCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProductconfiguratorconfiguratorEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ConfiguratorApi~productConfiguratorUpdateConfiguratorCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProductconfiguratorconfiguratorEntity}
     */
