...
export default class PropertyApi {
    ...
    */
     ...
     * @callback module:api/PropertyApi~productConfiguratorBulkCreatePropertiesCallback
     ...
     * @param {module:api/PropertyApi~productConfiguratorBulkCreatePropertiesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PropertyApi~productConfiguratorBulkUpdatePropertiesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PropertyApi~productConfiguratorBulkUpdatePropertiesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PropertyApi~productConfiguratorCreatePropertyCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PropertyApi~productConfiguratorCreatePropertyCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PropertyApi~productConfiguratorListPropertiesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PropertyApi~productConfiguratorListPropertiesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PropertyApi~productConfiguratorUpdatePropertyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ProductconfiguratorpropertyEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/PropertyApi~productConfiguratorUpdatePropertyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ProductconfiguratorpropertyEntity}
     */
