 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProductconfiguratorconfigurationStep
 * @version v1
 */
class ProductconfiguratorconfigurationStep {
    /**
     * Constructs a new <code>ProductconfiguratorconfigurationStep</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratorconfigurationStep
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratorconfigurationStep} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratorconfigurationStep} The populated <code>ProductconfiguratorconfigurationStep</code> instance.
     */
...
/**
 * @member {Array.<module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratorconfigurationOption>} options
 */
