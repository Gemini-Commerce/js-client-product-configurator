 ...
 * @module GeminiCommerce\ProductConfigurator/model/ConfigurationOptionProperty
 * @version v1
 */
class ConfigurationOptionProperty {
    /**
     * Constructs a new <code>ConfigurationOptionProperty</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ConfigurationOptionProperty
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationOptionProperty} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ConfigurationOptionProperty} The populated <code>ConfigurationOptionProperty</code> instance.
     */
