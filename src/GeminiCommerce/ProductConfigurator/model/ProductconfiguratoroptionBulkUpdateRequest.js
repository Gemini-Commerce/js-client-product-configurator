 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkUpdateRequest
 * @version v1
 */
class ProductconfiguratoroptionBulkUpdateRequest {
    /**
     * Constructs a new <code>ProductconfiguratoroptionBulkUpdateRequest</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkUpdateRequest
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkUpdateRequest} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkUpdateRequest} The populated <code>ProductconfiguratoroptionBulkUpdateRequest</code> instance.
     */
...
/**
 * @member {Array.<module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkUpdateRequestUpdateEntity>} options
 */
