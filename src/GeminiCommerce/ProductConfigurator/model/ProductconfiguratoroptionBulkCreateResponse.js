 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkCreateResponse
 * @version v1
 */
class ProductconfiguratoroptionBulkCreateResponse {
    /**
     * Constructs a new <code>ProductconfiguratoroptionBulkCreateResponse</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkCreateResponse
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkCreateResponse} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratoroptionBulkCreateResponse} The populated <code>ProductconfiguratoroptionBulkCreateResponse</code> instance.
     */
