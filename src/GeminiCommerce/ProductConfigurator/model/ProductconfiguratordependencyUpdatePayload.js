 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyUpdatePayload
 * @version v1
 */
class ProductconfiguratordependencyUpdatePayload {
    /**
     * Constructs a new <code>ProductconfiguratordependencyUpdatePayload</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyUpdatePayload
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyUpdatePayload} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyUpdatePayload} The populated <code>ProductconfiguratordependencyUpdatePayload</code> instance.
     */
