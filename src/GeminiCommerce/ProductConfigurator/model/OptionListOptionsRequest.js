 ...
 * @module GeminiCommerce\ProductConfigurator/model/OptionListOptionsRequest
 * @version v1
 */
class OptionListOptionsRequest {
    /**
     * Constructs a new <code>OptionListOptionsRequest</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/OptionListOptionsRequest
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/OptionListOptionsRequest} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/OptionListOptionsRequest} The populated <code>OptionListOptionsRequest</code> instance.
     */
