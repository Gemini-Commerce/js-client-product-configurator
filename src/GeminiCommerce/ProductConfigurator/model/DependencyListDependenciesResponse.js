 ...
 * @module GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse
 * @version v1
 */
class DependencyListDependenciesResponse {
    /**
     * Constructs a new <code>DependencyListDependenciesResponse</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse} The populated <code>DependencyListDependenciesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyEntity>} dependencies
 */
