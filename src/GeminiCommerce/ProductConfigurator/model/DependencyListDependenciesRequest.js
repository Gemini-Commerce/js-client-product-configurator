 ...
 * @module GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesRequest
 * @version v1
 */
class DependencyListDependenciesRequest {
    /**
     * Constructs a new <code>DependencyListDependenciesRequest</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesRequest
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesRequest} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesRequest} The populated <code>DependencyListDependenciesRequest</code> instance.
     */
