 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProductconfiguratormatrixCreateRequest
 * @version v1
 */
class ProductconfiguratormatrixCreateRequest {
    /**
     * Constructs a new <code>ProductconfiguratormatrixCreateRequest</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratormatrixCreateRequest
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratormatrixCreateRequest} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratormatrixCreateRequest} The populated <code>ProductconfiguratormatrixCreateRequest</code> instance.
     */
