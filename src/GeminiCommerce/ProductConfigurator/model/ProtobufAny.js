 ...
 * @module GeminiCommerce\ProductConfigurator/model/ProtobufAny
 * @version v1
 */
class ProtobufAny {
    /**
     * Constructs a new <code>ProtobufAny</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/ProtobufAny
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProtobufAny} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/ProtobufAny} The populated <code>ProtobufAny</code> instance.
     */
