 ...
 * @module GeminiCommerce\ProductConfigurator/model/PropertyListPropertiesRequest
 * @version v1
 */
class PropertyListPropertiesRequest {
    /**
     * Constructs a new <code>PropertyListPropertiesRequest</code>.
     * @alias module:GeminiCommerce\ProductConfigurator/model/PropertyListPropertiesRequest
     */
    constructor() { 
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/PropertyListPropertiesRequest} obj Optional instance to populate.
     * @return {module:GeminiCommerce\ProductConfigurator/model/PropertyListPropertiesRequest} The populated <code>PropertyListPropertiesRequest</code> instance.
     */
