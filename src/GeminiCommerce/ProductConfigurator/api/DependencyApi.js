...
/**
* Dependency service.
* @module GeminiCommerce\ProductConfigurator/api/DependencyApi
* @version v1
*/
export default class DependencyApi {
    ...
    * @alias module:GeminiCommerce\ProductConfigurator/api/DependencyApi
    * @class
    ...
    */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorCreateDependencyCallback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyEntity} data The data returned by the service call.
     ...
     * @param {String} stepId 
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyCreateRequest} body 
     * @param {module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorCreateDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyEntity}
     */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorDeleteDependencyCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorDeleteDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorListDependenciesCallback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesRequest} body 
     * @param {module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorListDependenciesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/DependencyListDependenciesResponse}
     */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorUpdateDependencyCallback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyEntity} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} dependencyId 
     * @param {module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyUpdateRequest} body 
     * @param {module:GeminiCommerce\ProductConfigurator/api/DependencyApi~productConfiguratorUpdateDependencyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/ProductconfiguratordependencyEntity}
     */
