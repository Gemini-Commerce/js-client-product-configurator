...
* @module GeminiCommerce\ProductConfigurator/api/ConfigurationApi
* @version v1
*/
export default class ConfigurationApi {
    ...
    * @alias module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi
    * @class
    ...
    */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetAvailableConfigurationCallback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetAvailableConfigurationResponse} data The data returned by the service call.
     ...
     * @param {module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetAvailableConfigurationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetAvailableConfigurationResponse}
     */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetAvailableConfiguration2Callback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetAvailableConfigurationResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} productId 
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetAvailableConfigurationRequest} body 
     * @param {module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetAvailableConfiguration2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetAvailableConfigurationResponse}
     */
     ...
     * @callback module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetConfigurationFromSelectionsCallback
     * @param {String} error Error message, if any.
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetConfigurationFromSelectionsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} tenantId 
     * @param {String} productId 
     * @param {module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetConfigurationFromSelectionsRequest} body 
     * @param {module:GeminiCommerce\ProductConfigurator/api/ConfigurationApi~productConfiguratorGetConfigurationFromSelectionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:GeminiCommerce\ProductConfigurator/model/ConfigurationGetConfigurationFromSelectionsResponse}
     */
