...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratoroptionUpdateRequest();
  });
  ...
  describe('ProductconfiguratoroptionUpdateRequest', function() {
    it('should create an instance of ProductconfiguratoroptionUpdateRequest', function() {
      // uncomment below and update the code to test ProductconfiguratoroptionUpdateRequest
      //var instance = new ProductConfiguratorService.ProductconfiguratoroptionUpdateRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratoroptionUpdateRequest);
    });
