...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratoroptionUpdatePayload();
  });
  ...
  describe('ProductconfiguratoroptionUpdatePayload', function() {
    it('should create an instance of ProductconfiguratoroptionUpdatePayload', function() {
      // uncomment below and update the code to test ProductconfiguratoroptionUpdatePayload
      //var instance = new ProductConfiguratorService.ProductconfiguratoroptionUpdatePayload();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratoroptionUpdatePayload);
    });
