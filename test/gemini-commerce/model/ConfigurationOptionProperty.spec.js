...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ConfigurationOptionProperty();
  });
  ...
  describe('ConfigurationOptionProperty', function() {
    it('should create an instance of ConfigurationOptionProperty', function() {
      // uncomment below and update the code to test ConfigurationOptionProperty
      //var instance = new ProductConfiguratorService.ConfigurationOptionProperty();
      //expect(instance).to.be.a(ProductConfiguratorService.ConfigurationOptionProperty);
    });
    ...
    it('should have the property subtractToGetVariation (base name: "subtractToGetVariation")', function() {
      // uncomment below and update the code to test the property subtractToGetVariation
      //var instance = new ProductConfiguratorService.ConfigurationOptionProperty();
      //expect(instance).to.be();
    });
