...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.MatrixWeightType();
  });
  ...
  describe('MatrixWeightType', function() {
    it('should create an instance of MatrixWeightType', function() {
      // uncomment below and update the code to test MatrixWeightType
      //var instance = new ProductConfiguratorService.MatrixWeightType();
      //expect(instance).to.be.a(ProductConfiguratorService.MatrixWeightType);
    });
