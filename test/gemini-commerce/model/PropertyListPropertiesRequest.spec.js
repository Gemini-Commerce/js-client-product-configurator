...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.PropertyListPropertiesRequest();
  });
  ...
  describe('PropertyListPropertiesRequest', function() {
    it('should create an instance of PropertyListPropertiesRequest', function() {
      // uncomment below and update the code to test PropertyListPropertiesRequest
      //var instance = new ProductConfiguratorService.PropertyListPropertiesRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.PropertyListPropertiesRequest);
    });
