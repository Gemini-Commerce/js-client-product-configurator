...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ConfigurationConfigurationStep();
  });
  ...
  describe('ConfigurationConfigurationStep', function() {
    it('should create an instance of ConfigurationConfigurationStep', function() {
      // uncomment below and update the code to test ConfigurationConfigurationStep
      //var instance = new ProductConfiguratorService.ConfigurationConfigurationStep();
      //expect(instance).to.be.a(ProductConfiguratorService.ConfigurationConfigurationStep);
    });
