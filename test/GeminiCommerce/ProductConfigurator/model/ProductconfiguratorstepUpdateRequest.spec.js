...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratorstepUpdateRequest();
  });
  ...
  describe('ProductconfiguratorstepUpdateRequest', function() {
    it('should create an instance of ProductconfiguratorstepUpdateRequest', function() {
      // uncomment below and update the code to test ProductconfiguratorstepUpdateRequest
      //var instance = new ProductConfiguratorService.ProductconfiguratorstepUpdateRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratorstepUpdateRequest);
    });
