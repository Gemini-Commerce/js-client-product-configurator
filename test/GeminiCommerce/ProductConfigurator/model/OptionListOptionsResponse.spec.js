...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.OptionListOptionsResponse();
  });
  ...
  describe('OptionListOptionsResponse', function() {
    it('should create an instance of OptionListOptionsResponse', function() {
      // uncomment below and update the code to test OptionListOptionsResponse
      //var instance = new ProductConfiguratorService.OptionListOptionsResponse();
      //expect(instance).to.be.a(ProductConfiguratorService.OptionListOptionsResponse);
    });
