...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratorstepBulkCreateRequest();
  });
  ...
  describe('ProductconfiguratorstepBulkCreateRequest', function() {
    it('should create an instance of ProductconfiguratorstepBulkCreateRequest', function() {
      // uncomment below and update the code to test ProductconfiguratorstepBulkCreateRequest
      //var instance = new ProductConfiguratorService.ProductconfiguratorstepBulkCreateRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratorstepBulkCreateRequest);
    });
