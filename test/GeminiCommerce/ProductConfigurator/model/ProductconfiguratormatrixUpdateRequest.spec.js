...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratormatrixUpdateRequest();
  });
  ...
  describe('ProductconfiguratormatrixUpdateRequest', function() {
    it('should create an instance of ProductconfiguratormatrixUpdateRequest', function() {
      // uncomment below and update the code to test ProductconfiguratormatrixUpdateRequest
      //var instance = new ProductConfiguratorService.ProductconfiguratormatrixUpdateRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratormatrixUpdateRequest);
    });
