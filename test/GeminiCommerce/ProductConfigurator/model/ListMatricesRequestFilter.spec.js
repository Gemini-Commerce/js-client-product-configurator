...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ListMatricesRequestFilter();
  });
  ...
  describe('ListMatricesRequestFilter', function() {
    it('should create an instance of ListMatricesRequestFilter', function() {
      // uncomment below and update the code to test ListMatricesRequestFilter
      //var instance = new ProductConfiguratorService.ListMatricesRequestFilter();
      //expect(instance).to.be.a(ProductConfiguratorService.ListMatricesRequestFilter);
    });
