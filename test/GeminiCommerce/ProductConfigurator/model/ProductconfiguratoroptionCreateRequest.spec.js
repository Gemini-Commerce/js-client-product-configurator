...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratoroptionCreateRequest();
  });
  ...
  describe('ProductconfiguratoroptionCreateRequest', function() {
    it('should create an instance of ProductconfiguratoroptionCreateRequest', function() {
      // uncomment below and update the code to test ProductconfiguratoroptionCreateRequest
      //var instance = new ProductConfiguratorService.ProductconfiguratoroptionCreateRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratoroptionCreateRequest);
    });
