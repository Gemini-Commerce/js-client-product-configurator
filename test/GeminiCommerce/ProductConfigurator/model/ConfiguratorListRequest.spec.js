...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ConfiguratorListRequest();
  });
  ...
  describe('ConfiguratorListRequest', function() {
    it('should create an instance of ConfiguratorListRequest', function() {
      // uncomment below and update the code to test ConfiguratorListRequest
      //var instance = new ProductConfiguratorService.ConfiguratorListRequest();
      //expect(instance).to.be.a(ProductConfiguratorService.ConfiguratorListRequest);
    });
