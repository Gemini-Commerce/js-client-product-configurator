...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratoroptionBulkUpdateRequestUpdateEntity();
  });
  ...
  describe('ProductconfiguratoroptionBulkUpdateRequestUpdateEntity', function() {
    it('should create an instance of ProductconfiguratoroptionBulkUpdateRequestUpdateEntity', function() {
      // uncomment below and update the code to test ProductconfiguratoroptionBulkUpdateRequestUpdateEntity
      //var instance = new ProductConfiguratorService.ProductconfiguratoroptionBulkUpdateRequestUpdateEntity();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratoroptionBulkUpdateRequestUpdateEntity);
    });
