...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.MatrixGenericType();
  });
  ...
  describe('MatrixGenericType', function() {
    it('should create an instance of MatrixGenericType', function() {
      // uncomment below and update the code to test MatrixGenericType
      //var instance = new ProductConfiguratorService.MatrixGenericType();
      //expect(instance).to.be.a(ProductConfiguratorService.MatrixGenericType);
    });
