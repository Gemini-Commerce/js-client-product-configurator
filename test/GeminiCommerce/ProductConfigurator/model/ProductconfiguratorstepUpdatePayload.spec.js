...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProductConfiguratorService.ProductconfiguratorstepUpdatePayload();
  });
  ...
  describe('ProductconfiguratorstepUpdatePayload', function() {
    it('should create an instance of ProductconfiguratorstepUpdatePayload', function() {
      // uncomment below and update the code to test ProductconfiguratorstepUpdatePayload
      //var instance = new ProductConfiguratorService.ProductconfiguratorstepUpdatePayload();
      //expect(instance).to.be.a(ProductConfiguratorService.ProductconfiguratorstepUpdatePayload);
    });
